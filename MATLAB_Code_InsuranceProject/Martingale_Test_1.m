function [n_dt,n_simulations]=Martingale_Test_1(rates,F0,sigmaEq,sigmaPr,T,...
                                seed)
% Function to compute the Martingale Test in the case of a single number of
% possible time steps
%
% INPUTS
...
fprintf(['The minimum error is %d, the best number of time steps is  %d and %d ' ...
